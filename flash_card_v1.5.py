...
class DictionaryWindow:
    ...
    def display_results(self, result):
        ...
        self.text_area.tag_config('word', font=('Helvetica', 14, 'bold'), foreground=COLORS['primary'])
        self.text_area.tag_config('pronunciation', font=('Helvetica', 12), foreground=COLORS['accent'])
        self.text_area.tag_config('section_header', font=('Helvetica', 12, 'bold'), foreground=COLORS['text_primary'])
        self.text_area.tag_config('definition', font=('Helvetica', 11), foreground=COLORS['text_primary'])
        self.text_area.tag_config('example', font=('Helvetica', 11), foreground=COLORS['text_secondary'])
...
class ModernFlashcardApp:
    ...
    def search_dictionary(self):
        ...
        word_to_search = self.current_qa[0].strip()
